    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:"url('/assets/images/AboutUs.jpeg')",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-300 mb-4">
                Founded in 2015 in Nairobi, Kenya Bespoke Suits was born from a vision to redefine luxury tailoring. Our founder,saw an opportunity to blend traditional Kenyan craftsmanship with modern design, creating suits that tell a story of elegance and pride.
              </p>
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="text-center">
        <img
          src="/assets/images/Founder & CEO.jpeg"
          alt="Dennis Sifuna - Founder & CEO"
          className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-gold-500 shadow-lg"
          loading="lazy"
        />
        <h3 className="text-xl font-semibold text-white">Dennis Sifuna</h3>
      ...
      <div className="text-center">
        <img
          src="/assets/images/Co-Founder & Managing director.jpeg"
          alt="Co-Founder & Managing Director"
          className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-gold-500 shadow-lg"
          loading="lazy"
        />
        <h3 className="text-xl font-semibold text-white">[Name Placeholder]</h3>
        <p className="text-gray-400">Co-Founder & Managing Director</p>
      </div>

      {/* Team Member 3 */}
      <div className="text-center">
        <img
          src="/assets/images/Marketing Director.jpeg"
          alt="Maheq Noor - Marketing Director"
          className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-gold-500 shadow-lg"
          loading="lazy"
        />
        <h3 className="text-xl font-semibold text-white">Maheq Noor</h3>
