  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setPopupMessage(data.message || 'Thank you for subscribing! You’ll receive our latest updates.');
      }
    } catch (error: any) {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-300 italic mb-6">"As a woman in business, finding the perfect suit has always been a challenge. Don's Custom Clothiers delivered a suit that makes me feel powerful and confident."</p>
              <div className="flex items-center">
